...
export const SingleFoodItem = ({ item, col, admin }: { item: FoodItem; col?: boolean; admin?: boolean }) => {
	const { id, title, price, calories, imageURL, description } = item

	return (
		<motion.div
			whileTap={{ rotate: [0, -1, 1, -1, 0] }}
			className={`${!col ? 'w-[275px] min-w-[275px]' : 'w-[320px] min-w-[320px]'} md:w-[300px] md:min-w-[300px] ${
