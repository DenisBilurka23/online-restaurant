...
const Button: FC<{ category: Category; categoryId: string; url?: string }> = ({ categoryId, category, url }) => {
	return (
		<Link
			...
			whileTap={{ scale: 1.1 }}
			className={`group ${category.id === +categoryId
		...
		>
			...
			<p
				className={`text-base ${category.id === +categoryId
