...
const SidenavMenu = ({
	...
	>
		...
		<NavItem
			...
			setActivePage={setActivePage}
			setPageContent={setPageContent}
			pageContent={<div className="w-full flex tems-center justify-center">Orders</div>}
		/>
		<NavItem
			activePage={activePage}
			svgIcon={<FiUsers />}
		...
		<NavItem
			...
			setActivePage={setActivePage}
			setPageContent={setPageContent}
			pageContent={<div className="w-full flex tems-center justify-center">Settings</div>}
		/>
	</motion.nav>
)
