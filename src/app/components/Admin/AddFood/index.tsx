			...
			<div className="border w-full  flex border-gray-300 items-center rounded-lg p-4 flex-col justify-center gap-4  ">
				...
				<div className="w-full flex flex-col md:flex-row items-center gap-3">
					<div className="w-full py-2 border-b border-gray-300 flex items-center gap-2">
						...
						<CategoriesSelector categories={Categories} action={setCategory} selected={category} />
					</div>
					<div className="w-full py-2 border-b border-gray-300 flex items-center gap-2">
						...
						<input
							...
							value={quantity}
							onChange={e => {
								setQuantity(validateNumber(e.target.value))
							}}
						/>
					</div>
				</div>
							...
							{image ? (
								<>
									<div className="relative h-full">
										<Image src={image} alt="uploaded food" className="w-full h-full object-cover" />
										<motion.button
											whileTap={{ scale: 1.1 }}
				...
				<div className="w-full flex flex-col md:flex-row items-center gap-3">
					...
					<div className="w-full py-2 border-b border-gray-300 flex items-center gap-2">
						...
						<input
							...
							value={price}
							onChange={e => {
								setPrice(validateNumber(e.target.value))
							}}
						/>
					</div>
				</div>
